...
SUPPORTED_MODEL_SIZES = ["base", "small", "medium", "large-v3"] # large-v2 removed for simplicity, add if needed
DEFAULT_MODEL_SIZE = "small" # Default to small for broader compatibility
# --- END MODIFICATION ---
...
AUDIO_BUFFER_SECONDS = 1 # Process audio in chunks of this duration (Adjust if needed)
PYAUDIO_FRAMES_PER_BUFFER = 512 # How many frames PyAudio reads at a time
            ...
            try:
                ...
                if audio_np.size > 0:
                    ...
                    segments, info = model.transcribe(
                        ...
                        beam_size=2, # Adjust beam size as needed
